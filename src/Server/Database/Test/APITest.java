...
public class APITest {
    ...
    public void testGetMessageForPutUserInGroup_Coordinator() {
        ...
        // Test case for successfully putting a user in a group when the user is a coordinator
        String[] putUserInGroup = {"", "put", "userInGroup", "1", "2"};
        API api = new API(putUserInGroup, proxy, 1); // Assuming user with ID 1 is the coordinator for group chat with ID 1
        String result = api.getMessage();

        // Assuming the successful result will be in the format: "User <userID> added to group <groupID>"
    ...
    public void testGetMessageForPutMessage() {
        ...
        // Assuming the successful result will be in the format: "Message sent to group <groupID>"
    ...
    public void testGetMessageForGetUsers() {
        ...
        // Becasue it's hard to assert the exact result since it depends on the current state of the database.
    ...
    public void testGetMessageForGetCoordinator() {
        ...
        System.out.println(result);
        // Assert that the result is not null and the coordinator ID matches the user ID (since the creator is the coordinator)
        assertNotNull(result);
